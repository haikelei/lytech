(function () {
    var h = {}, mt = {}, c = {
        id: "12f90647e8ee1a13b2b0e7591c5ec2d0",
        dm: ["xiyoukeji.com"],
    ...
    mt.h.Wa = function (a) {
        var b = mt.h.oa(a), d = {top: 0, left: 0};
    ...
    (mt.h.Z = function () {
        ...
        (function () {
            if (!d) if (d = s, "complete" === document.readyState) a.A = s; else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
                f, u), window.addEventListener("load", a, u); else if (document.attachEvent) {
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    l = ["{"];
                    e = mt.l.stringify;
                    for (m in d) if (Object.prototype.hasOwnProperty.call(d, m)) switch (n =
                        d[m], typeof n) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!l || !n) && e && k) v = s, p = +new Date; else if (l && n && (!e || !k)) v = u, q += +new Date - p;
            l = e;
            n = k;
            y = setTimeout(b, 100)
        }
        ...
        function d(a) {
            var n = document, p = "";
            if (a in n) p = a; else for (var d = ["webkit", "ms", "moz", "o"], b = 0; b < d.length; b++) {
        ...
        var f = mt.event, m = h.G, l = s, e = s, n = s, k = s, w = +new Date, p = w, q = 0, v = s,
            x = d("visibilityState"), z = d("hidden"), y;
        b();
        (function () {
    ...
    (function () {
        var a = mt.lang, b = h.D, d = h.load, g = {
            Ba: function (f) {
    ...
    (function () {
        function a(a, d, b, p) {
            if (!(a === r || d === r || p === r)) {
                ...
                a = String(a).split("!");
                for (var q, e = u, x = 0; x < a.length; x++) if (q = a[x].split("*"), String(d) === q[0]) {
                    q[1] = b;
                    q[2] = p;
                    a[x] = q.join("*");
                    e = s;
        ...
        var d = mt.lang, g = mt.l, f = h.D, m = h.G, l = h.ga, e = {
            s: [], B: 0, W: u, o: {R: "", page: ""}, init: function () {
                e.e = 0;
                m.c("pv-b",
                    function () {
                        e.ha();
                ...
                var a = window._hmt;
                if (a && a.cmd && a.cmd[c.id]) for (var d = a.cmd[c.id], b = /^_track(Event|MobConv|Order|RTEvent)$/, p = 0, q = d.length; p < q; p++) {
                    var f = d[p];
                    b.test(f[0]) ? e.s.push(f) : e.O(f)
                }
                a.cmd[c.id] = {push: e.O}
            }, la: function () {
                if (0 < e.s.length) for (var a = 0, d = e.s.length; a < d; a++) e.O(e.s[a]);
                e.s = t
            }, O: function (a) {
                var b = a[0];
            ...
            _setAccount: function (a) {
                ...
                2 < a.length && (e.e |= 8, h.b.a.nv =
                    0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = d.j(a[1]) + "*" + d.j(a[2]) + (a[3] ? "*" + d.j(a[3]) : "") + (a[4] ? "*" + d.j(a[4]) : ""), h.b.k())
                ...
                if (!(3 >
                    ...
                    b = d.j(b[2]);
                    if (e !== r && b !== r) {
                        var f = decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), f = a(f, e, 1, b);
                ...
                if (d.d(a,
                    ...
                    if (900 >= l) k.call(this, a); else for (var l = Math.ceil(l / 900), p = "block|" + Math.round(Math.random() * f.N).toString(16) + "|" + l + "|", q = [], v = 0; v < l; v++) q.push(v), q.push(a.substring(900 * v, 900 * v + 900)), k.call(this, p + q.join("|")), q = []
                }
    ...
    (function () {
        ...
        var b = mt.url, d = mt.$, g = mt.Q, f = mt.lang, m = mt.cookie, l = mt.i, e = mt.localStorage,
            n = mt.sessionStorage, k = h.D, w = h.G;
        a.prototype = {
            L: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a =
                    u;
                this.z(document.referrer) && this.z(document.location.href) ? a = s : (a = b.U(document.referrer), a = this.L(a || "", document.location.hostname));
                ...
                try {
                    m.set(a, b, {domain: this.I(), path: this.T(), H: d}), d ? e.set(a, b, d) : n.set(a, b)
                } catch (f) {
                }
            }, Da: function (a) {
                try {
                    m.set(a, "", {domain: this.I(), path: this.T(), H: -1}), n.remove(a), e.remove(a)
                } catch (b) {
                }
            }, Ia: function () {
                var a, b, d, e, f;
            ...
            Ja: function () {
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(k.da),
                    f = b.f(a, "jn"), g = /^heatlink$|^select$|^pageclick$/.test(f);
                ...
                var a = this, b = n.get("Hm_unsent_" + c.id);
    ...
    (function () {
        var a = mt.h, b = mt.event, d = mt.url, g = mt.l;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                var f = +new Date, m = function (a) {
    ...
    (function () {
        var a = mt.i, b = mt.lang, d = mt.event, g = mt.l;
        if ("undefined" !== typeof h.b && (c.med || (!a.Ca || 7 < a.Aa) && c.cvcc)) {
            ...
            if ("undefined" !== typeof e && "undefined" !== typeof l) {
                ...
                var v = function (a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0, f = d.length; e < f; e++) if (q === d[e]) return w(m + a + "/" + (e + 1), d[e]), u
                };
    ...
    (function () {
        var a = mt.h, b = mt.lang, d = mt.event, g = mt.l;
